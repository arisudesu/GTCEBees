...
public class ForestryMachineRecipes {
    public static void init() {
        RecipeManagers.centrifugeManager.addRecipe(20, ModuleApiculture.getItems().propolis.getItemStack(), ImmutableMap.of(MetaItems.STICKY_RESIN.getStackForm(), 1.0f));

        //Combs
        RecipeManagers.centrifugeManager.addRecipe(20, GTCombItem.getComb(GTCombs.LIGNITE, 1), ImmutableMap.of(OreDictUnifier.get(OrePrefix.gem, Materials.Charcoal), 0.9f, ModuleCore.getItems().beeswax.getItemStack(), 0.3f));
        ...
        RecipeManagers.centrifugeManager.addRecipe(20, GTCombItem.getComb(GTCombs.RUBBERY, 1), ImmutableMap.of(MetaItems.STICKY_RESIN.getStackForm(), 0.7f, ModuleCore.getItems().beeswax.getItemStack(), 0.3f));
